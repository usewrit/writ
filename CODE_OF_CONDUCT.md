...
[GitHub Security Advisory](https://github.com/usewrit/writ/security/advisories/new)
— it is a private channel to the maintainers and needs no email address — or, if
the matter is not sensitive, by opening an issue.
