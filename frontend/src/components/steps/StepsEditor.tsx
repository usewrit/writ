...
export const StepsEditor: React.FC<StepsEditorProps> = ({ steps, onSave, existingFunctionNames, onCreateFunction }) => {
  ...
  return (
    <div className="bg-surface border border-border/80 rounded-xl overflow-hidden">
          ...
          <div className="mb-3 rounded-xl border border-ink/15 bg-ink/[0.03] p-3 space-y-2.5">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-48 px-2.5 py-1.5 text-xs font-mono bg-surface border border-border rounded-lg outline-none focus:border-ink/30"
              />
              ...
              return (
                ...
                >
                  <span className={clsx(
                    ...
                    sel ? 'bg-ink border-ink text-white' : 'border-border',
                  )}>
        ...
        {draft.length === 0 && addingAt === null ? (
          <div className="flex flex-col items-center justify-center py-10 text-center">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium border border-dashed border-border rounded-full text-secondary hover:text-ink hover:border-ink/40 transition-colors"
            >
      ...
      {/* Sticky save bar */}
      {dirty && !selecting && (
        <div className="sticky bottom-0 flex items-center gap-3 px-4 py-2.5 bg-surface/95 backdrop-blur border-t border-border">
...
function InsertPoint({ idx, addingAt, setAddingAt, onInsert }: {
  ...
  return (
    <div className="group/insert relative h-1.5 -my-0.5">
      ...
      >
        <span className="flex-1 h-px bg-active" />
